...
export AS_PROJECT_PATH := G:/GitRepos/Brewery/DietrichBrewery
export AS_PROJECT_NAME := DietrichBrewing
export AS_SYSTEM_PATH := C:/BRAutomation/AS/System
export AS_VC_PATH := C:/BRAutomation/AS412/AS/VC
export AS_TEMP_PATH := G:/GitRepos/Brewery/DietrichBrewery/Temp
export AS_CONFIGURATION := Config1
export AS_BINARIES_PATH := G:/GitRepos/Brewery/DietrichBrewery/Binaries
...
export WIN32_AS_PROJECT_PATH := "G:\GitRepos\Brewery\DietrichBrewery"
export WIN32_AS_SYSTEM_PATH := "C:\BRAutomation\AS\System"
export WIN32_AS_VC_PATH := "C:\BRAutomation\AS412\AS\VC"
export WIN32_AS_TEMP_PATH := "G:\GitRepos\Brewery\DietrichBrewery\Temp"
export WIN32_AS_BINARIES_PATH := "G:\GitRepos\Brewery\DietrichBrewery\Binaries"
