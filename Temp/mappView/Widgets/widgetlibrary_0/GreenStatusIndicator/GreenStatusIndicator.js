define(['system/widgets/CompoundWidget/CompoundWidget', 'brease/core/Types', 'text!widgets/widgetlibrary_0/GreenStatusIndicator/content/widgets.css'], function (SuperClass, Types, contentCSS) {

    'use strict';

    /**
    * @class widgets.widgetlibrary_0.GreenStatusIndicator
    ...
    */ 
    ...
    var defaultSettings = {
        ...
        WidgetClass = SuperClass.extend(function GreenStatusIndicator() {
